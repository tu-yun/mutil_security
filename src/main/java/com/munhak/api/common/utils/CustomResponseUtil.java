package com.munhak.api.common.utils;
...
public class CustomResponseUtil {
    ...
    public static void success(HttpServletResponse response, String msg, Object dto) {
        try {
            ...
            ResponseDto<?> responseDto = new ResponseDto<>(ResultCodeType.SUCCESS, msg, dto);
    ...
    public static void fail(HttpServletResponse response, String msg, HttpStatus httpStatus) {
        try {
            ObjectMapper om = new ObjectMapper();
            ResponseDto<?> responseDto = new ResponseDto<>(ResultCodeType.FAIL, msg, null, null);
            String responseBody = om.writeValueAsString(responseDto);
            response.setContentType("application/json; charset=utf-8");
